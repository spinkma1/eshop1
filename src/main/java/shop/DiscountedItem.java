...
public class DiscountedItem extends Item {
    ...
    public DiscountedItem(int id, String name, float price, String category, float discount, Date discountFrom, Date discountTo) {
    ...
    public DiscountedItem(int id, String name, float price, String category, float discount, String discountFrom, String discountTo)  {
        super(id, name, price, category);
